...
<footer class="flex flex-col py-16 bg-gray-800">
    ...
    <div class="flex flex-col lg:flex-row gap-12 p-4 text-white text-center lg:text-left">
        ...
        <div class="text-center w-full md:w-1/3">
            ...
            <p>{{ config('app.code') }}</p>
            <p class="font-sm text-orange-500">{{ config('app.name') }} </p>
        </div>

        <div class="text-center w-full md:w-1/3 lg:text-right">

            <p>Ankara, Türkiye</p>
            <p>katemiz@gmail.com</p>
            <div class="flex flex-row justify-center lg:justify-end py-4">
    ...
    <div class="text-center font-sm text-gray-500 m-8">
